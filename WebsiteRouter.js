 ...
 *     description: Returns paginated jobs (20 per page) for public website. Excludes internships and only includes accepted visibility jobs. Supports filters for workplace type, company name, job type, categories, and location.
 *     parameters:
 *       - in: query
 *         name: page
 *         schema:
 ...
 *     description: Returns paginated companies (20 per page) for public website. Only approved/visible companies.
 *     parameters:
 *       - in: query
 *         name: page
 *         schema:
