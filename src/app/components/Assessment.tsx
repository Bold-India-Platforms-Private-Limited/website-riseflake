...
export default function Assessment() {
  const allCards: CardDef[] = [
    { icon: Code, title: 'Hackathons & Challenges' },
    { icon: HelpCircle, title: 'Innovation Competition' },
    { icon: Briefcase, title: 'Jobs Listings' },
    { icon: FileText, title: 'Internship Posting' },
    { icon: Globe, title: 'Branded Mini Website' },
    { icon: Building2, title: 'Resume Parsing' },
    { icon: Sparkles, title: 'AI Profile Score' },
    { icon: Users, title: 'Manage Candidates' },
    { icon: Monitor, title: 'Skill-based Assessments' },
    { icon: ListIcon, title: '2,239+ Question Bank' },
    { icon: LinkIcon, title: 'Assessment Unique Link' },
    { icon: TranslateIcon, title: 'AI Interviews' },
    { icon: Calendar, title: 'Schedule Interview' },
    { icon: Video, title: 'Live Coding Assess' },
    { icon: FileCheck, title: 'Automated Evaluations' },
    { icon: RotateCw, title: '360° Proctoring' },
    { icon: CreditCard, title: 'ID Verification' },
