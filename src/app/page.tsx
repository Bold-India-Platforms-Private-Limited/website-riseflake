        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-gradient">Riseflake</h1>
            </div>
            <a
              href="https://app.riseflake.com/home"
              className="px-6 py-2.5 bg-gradient-modern text-white hover:shadow-lg hover:shadow-indigo-400/50 rounded-full font-semibold transition-all"
            >
              Find Jobs Now
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-bold text-lg text-slate-900">Riseflake</h4>
              </div>
              <p className="text-slate-600 text-sm leading-relaxed">
                The leading job portal and professional networking platform for career growth and success.
              </p>
            </div>
            <div>
              <h5 className="font-bold mb-4 text-slate-900">Job Portal</h5>
            ...
            <div>
              <h5 className="font-bold mb-4 text-slate-900">Professional Networking</h5>
              <ul className="space-y-3 text-sm text-slate-600">
                <li>
                  <a href="https://app.riseflake.com/home" className="hover:text-indigo-600 transition">
            ...
            <div>
              <h5 className="font-bold mb-4 text-slate-900">Legal</h5>
              <ul className="space-y-3 text-sm text-slate-600">
                <li>
                  <a href="#" className="hover:text-indigo-600 transition">
                    Privacy Policy
          ...
          <div className="border-t border-slate-200 pt-8">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
              <p className="text-slate-600 text-sm">
                © 2024-2026 Riseflake. Transforming careers on the world's best job portal and professional networking platform.
              </p>
