...
const formatSalary = (job: JobDetail): string => {
...
export default function JobHeader({ job }: { job: JobDetail }) {
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      {/* Top accent bar for active jobs */}
      {isActive && (
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <InfoCell
            ...
            label="Salary"
            value={salary}
            valueClass={salary !== 'Not disclosed' && salary !== 'Confidential' ? 'text-emerald-700 font-bold' : undefined}
          />
          <InfoCell
            icon={
              <svg className="h-4 w-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
